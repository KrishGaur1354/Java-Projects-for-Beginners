...
public class Reservation {
	...
	private void initialize() {
		...
		JRadioButton rdbtnFirstAC = new JRadioButton("First Class AC");
		rdbtnFirstAC.setBounds(137, 281, 111, 23);
		frame.getContentPane().add(rdbtnFirstAC);
		
		JRadioButton rdbtnSecondAC = new JRadioButton("Second Class AC");
		rdbtnSecondAC.setBounds(137, 307, 111, 23);
		frame.getContentPane().add(rdbtnSecondAC);
		
		JRadioButton rdbtnThirdAC = new JRadioButton("Third Class AC");
		...
		separator_8_1.setBounds(127, 363, 298, 29);
		...
		textField_1.setBounds(1010, 425, 96, 20);
		...
		JLabel lblNewLabel_6 = new JLabel("Ticket");
		lblNewLabel_6.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_6.setBounds(560, 190, 49, 14);
		frame.getContentPane().add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("Adult");
		lblNewLabel_7.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblNewLabel_7.setBounds(667, 190, 49, 14);
		frame.getContentPane().add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("Child");
		...
		JSeparator separator_12_1 = new JSeparator();
		...
		JLabel lblNewLabel_14 = new JLabel("Date of Journey");
